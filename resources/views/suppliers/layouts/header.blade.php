         ...
         <div class="sidebar-body pt-0 data-scrollbar">
             <div class="sidebar-list">
                 ...
                 <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                     ...
                     <li class="nav-item">
                         <a class="nav-link" aria-current="page" href="/supplier/dashboard">
                     ...
                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#user-master" role="button"
                             ...
                             <span class="item-name">User Masters</span>
                             <i class="right-icon">
                         ...
                         <ul class="sub-nav collapse" id="user-master" data-bs-parent="#sidebar-menu">
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/user-role">
                                     <i class="icon">
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="User Role"
                                         data-bs-placement="right"> User Role </i>
                                     <span class="item-name"> User Role </span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/users">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Users"
                                         data-bs-placement="right"> Users </i>
                     ...
                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                             ...
                             <span class="item-name">Product Masters</span>
                             <i class="right-icon">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="18" class="icon-18"
                                     fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                         ...
                         <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/product-gst">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/product-uom">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Unit Type"
                                         data-bs-placement="right"> UOM </i>
                                     <span class="item-name"> Unit Type </span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/product-brand">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/product-category">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/product-sub-category">
                     ...
                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#customers-mgmt" role="button"
                             aria-expanded="false" aria-controls="horizontal-menu">
                             <i class="fa fa-users" aria-hidden="true"></i>
                         ...
                         <ul class="sub-nav collapse" id="customers-mgmt" data-bs-parent="#sidebar-menu">
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/customers/2">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/customers/1">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/customers/0">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                     ...
                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#order-management" role="button"
                             aria-expanded="false" aria-controls="horizontal-menu">
                         ...
                         <ul class="sub-nav collapse" id="order-management" data-bs-parent="#sidebar-menu">
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/orders/pending">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/orders/processing">
                                     <i class="icon svg-icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Processing Order"
                                         data-bs-placement="right"> PO </i>
                                     <span class="item-name">Processing Orders</span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                <a class="nav-link " href="/supplier/orders/complete">
                                    <i class="icon svg-icon">
                                        <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                    ...
                                    <span class="item-name">Complete Orders</span>
                                </a>
                            </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/orders/dispatch">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Dispatch Orders"
                                         data-bs-placement="right"> DO </i>
                                     <span class="item-name">Dispatch Order</span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/supplier/orders/delivered">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Delivered Orders"
                                         data-bs-placement="right"> DO </i>
                                     <span class="item-name">Delivered Orders</span>
                                 </a>
                             </li>
                         </ul>
                     </li>
                     ...
                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#reports" role="button"
                             ...
                             <span class="item-name">Reports & Analysis</span>
                             <i class="right-icon">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="18" class="icon-18"
                                     fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                     ...
                                     <li class="nav-item ">
                                         ...
                                         <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                             <li class="nav-item"><a class="nav-link active"
                                                     href="/supplier/dashboard">Dashboard</a></li>
                                             ...
                                             <li class="nav-item">
                                                 ...
                                                 <ul aria-expanded="false"
                                                     ...
                                                     <li class="nav-item"><a class="nav-link "
                                                             ...
                                                             Dashboard</a></li>
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/index-dual-compact.html">Dual
                                                             Compact</a></li>
                                                     <li class="nav-item"><a class="nav-link "
                                         ...
                                         <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                             ...
                                             <li class="nav-item">
                                                 ...
                                                 <ul aria-expanded="false"
                                                     ...
                                                     <li class="nav-item"><a class="nav-link "
                                                             ...
                                                             Verified</a></li>
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/auth/recoverpw.html">Reset
                                                             Password</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                                     ...
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/auth/two-factor.html">Two Factor</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                             ...
                                             <li class="nav-item">
                                                 ...
                                                 <ul aria-expanded="false"
                                                     ...
                                                     id="userApps">
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/app/user-profile.html">User
                                                             Profile</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                             ...
                                             <li class="nav-item">
                                                 ...
                                                 <ul aria-expanded="false"
                                                     ...
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/plugins/quill-editor.html">Quill</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                         ...
                                         <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                             <li class="nav-item">
                                                 ...
                                                 <ul aria-expanded="false"
                                                     ...
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/ui-elements/ui-cards.html">Cards</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/ui-elements/ui-carousel.html">Carousel</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/ui-elements/ui-grid.html">Grid</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                                     ...
                                                     <li class="nav-item"><a class="nav-link "
                                                             ...
                                                             Group</a></li>
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/ui-elements/ui-modal.html">Modal</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                                     ...
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/ui-elements/ui-tabs.html">Tabs</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                             ...
                                             <li class="nav-item">
                                                 ...
                                                 <ul aria-expanded="false"
                                                     ...
                                                     id="widgetsPage">
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/widget/widgetbasic.html">Widget
                                                             Basic</a></li>
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/widget/widgetchart.html">Widget
                                                             Chart</a></li>
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/widget/widgetcard.html">Widget
                                                             Card</a>
                                                     </li>
                                                 </ul>
                                             </li>
                                             ...
                                             <li class="nav-item">
                                                 ...
                                                 <ul aria-expanded="false"
                                                     ...
                                                     id="formsPages">
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/form/form-element.html">Element</a>
                                                     </li>
                                                     <li class="nav-item"><a class="nav-link "
                                             ...
                                             <li class="nav-item">
                                                 ...
                                                 <ul aria-expanded="false"
                                                     ...
                                                     <li class="nav-item"><a class="nav-link "
                                                             href="../dashboard/icons/dual-tone.html">Dual Tone</a>
                                                     </li>
                                                 </ul>
                                             </li>
                                         </ul>
                                 ...
                                 <ul class="p-0 sub-drop dropdown-menu dropdown-menu-end"
                                     ...
                                     <li class="">
                                         <div
                                             ...
                                             <div class="header-title">
                                                 <h5 class="mb-0 text-white">Wallet History</h5>
                                             </div>
                                         </div>
                                         <div class="p-0 card-body all-notification">
